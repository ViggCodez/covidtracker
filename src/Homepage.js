...
const data2 = [
  {
    ...
    content: <>
      <p>COVID-19 symptoms vary from person to person. In fact, some infected people don't develop any symptoms (asymptomatic). In general, people with COVID-19 report some of the following symptoms: Fever or chills. Cough. Shortness of breath or difficulty breathing. Tiredness. Muscle or body aches. Headaches. New loss of taste or smell. Sore throat. Congestion or runny nose. Nausea or vomiting. Diarrhea. Additional symptoms are possible. Symptoms may appear two to 14 days after exposure to the virus. Children have similar, but usually milder, symptoms than adults. Older adults and people who have severe underlying medical conditions are at higher risk of more serious complication from COVID-19.</p>
    </>
  },
  {
    nav: 'Diagnosis',
    ...
    content:
      <>
        ...
        <p>COVID-19 is diagnosed with a laboratory test. Your healthcare provider may collect a sample of your saliva or swab your nose or throat to send for testing.</p>
        <h4> When should I be tested for the coronavirus (COVID-19)?</h4>
        <p>Call your healthcare provider if you: Feel sick with fever, cough or have difficulty breathing. Have been in close contact with a person known or suspected to have COVID-19. Your healthcare provider will ask you questions about your symptoms and tell you if you need to be tested for COVID-19.</p>
      </>
  },
  {
    nav: 'Treatment',
    ...
    content:
      <>
        ...
        <p>Treatments for COVID-19 vary depending on the severity of your symptoms. If you’re not in the hospital or don’t need supplemental oxygen, no specific antiviral or immunotherapy is recommended. Depending on the severity of your COVID symptoms, you may need: Supplemental oxygen (given through tubing inserted into your nostrils). Some people may benefit from an infusion of monoclonal antibodies. Antiviral medications may reduce the risk of hospitalization and death in certain patients with COVID-19. Mechanical ventilation (oxygen through a tube inserted down your trachea). You are given medications to keep you comfortable and sleepy as long as you’re receiving oxygen through a ventilator. Extra corporeal membrane oxygenation (ECMO). You continue to receive treatment while a machine pumps your blood outside your body. It takes over the function of your body’s lungs and heart.</p>
        <h4>Can vaccinated people still get COVID-19?</h4>
        <p>Yes, it’s possible to get COVID-19 even if you’ve been vaccinated. No vaccines are 100% effective. In fact, breakthrough cases (when someone tests positive more than two weeks after they're fully vaccinated) are expected, especially as the SARS-CoV-2 virus mutates. The vaccines significantly reduce — but don’t eliminate — your risk of infection. The risk of a severe illness or death from a breakthrough infection is very low.</p>
      </>
  },
  {
    nav: 'Prevention',
  ...
  return (
    <div className="home-details">
      <div className="sub-nav">
        {
          data2.map((cont) => <div key={cont.nav} className="item" onClick={() => handleTabChange(cont.nav)}>{cont.nav}</div>)
        }
      </div>
